# nvim-treesitter-queries-haskell_persistent

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-haskell_persistent/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-haskell_persistent/actions/workflows/validate.yml)

Neovim tree-sitter queries for **haskell_persistent**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-haskell_persistent",
...
- [ ] Changes are scoped to `haskell_persistent` — do not include files for other languages
